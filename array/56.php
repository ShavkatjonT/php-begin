...
<body>
    <h1>
        N (≤ 15) o‘lchamli butun sonli A massivi berilgan. Undagi 3 ga karrali indekslarga ega elementlarni olib, yangi B massiviga joylashtiring (masalan, A3, A6, A9, ...). If (shart operatori) ishlatilmasin. B massivining o‘lchami va elementlari chiqarilsin.
