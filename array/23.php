...
<body>
    <h1>
        N hajmli massiv va K va L (1 < K <=L <=N ) butun sonlar berilgan. Massivning barcha elementlarining arifmetik oʻrtacha qiymatini toping, K dan L gacha boʻlgan raqamlardan tashqari.
...
if ($_POST) {
    ...
    if (1 >= $k) {
        die("K ni qiymati 1 dan katta bo'lishi kerak!");
    }
    if ($l < $k) {
